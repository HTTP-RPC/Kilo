...
public class BeanAdapter extends AbstractMap<String, Object> {
     ...
     * <li>If the target type is {@link URL}, the value is adapted via
     ...
     * to be a map. An instance is of the bean type is  dynamically created and
     * populated using the entries in the map. Property values are adapted as
     * described above. If a property provides multiple  setters, the first
     * applicable setter will be applied.
     *
     * @param <T>
     * The target type.
     *
