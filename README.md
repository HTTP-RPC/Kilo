...
For example, the following code could be used to deserialize the JSON data generated by the earlier example back into a collection of `TreeNode` instances:
