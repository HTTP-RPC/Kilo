...
# Introduction
Kilo is an open-source framework for creating and consuming RESTful and REST-like web services in Java. It also includes a number of ETL (extract/transform/load) and general-purpose developer productivity features.
